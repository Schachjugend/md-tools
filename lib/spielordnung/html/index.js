...
function scaffold (html, options) {
  ...
  let info = []
  if (options.commitMd) {
    info.push(`<a href="https://github.com/Schachjugend/Spielordnung">Spielordnung</a>@<a href="https://github.com/Schachjugend/Spielordnung/commit/${options.commitMd}">${options.commitMd}</a>`)
  }
  if (options.commitCreator) {
    info.push(`<a href="https://github.com/Schachjugend/md-tools">md-tools</a>@<a href="https://github.com/Schachjugend/md-tools/commit/${options.commitCreator}">${options.commitCreator}</a>`)
  }
  if (info.length !== 0) {
