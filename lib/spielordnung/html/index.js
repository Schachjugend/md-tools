...
function scaffold (html, options) {
  ...
  let info = []
  if (options.commitMd) {
    info.push(`<a href="https://github.com/Schachjugend/Spielordnung">Spielordnung</a>@<a href="https://github.com/Schachjugend/Spielordnung/commit/${options.commitMd}">${options.commitMd.subst(0, 6)}</a>`)
  }
