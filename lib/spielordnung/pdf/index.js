...
function getDate(input) {
  ...
  var jvBeschlossen = md.match('Diese Jugendspielordnung wurde von der Jugendversammlung der Deutschen Schachjugend am (.*) in .* beschlossen')[1]
  var jvChanged = md.match('Diese Jugendspielordnung wurde von der Jugendversammlung der Deutschen Schachjugend am 22. August 2020 in Magdeburg beschlossen und zuletzt am (.*) in .* geändert.')
  jvChanged = (jvChanged ? jvChanged[1] : jvBeschlossen)
  var aksChanged = md.match('Die Ausführungsbestimmungen wurden zuletzt (vom Arbeitskreis Spielbetrieb|vom Vorstand|von der Jugendversammlung) am (.*) geändert.')
